...
const HowItWorks = () => {
  return (
    <section className="py-24 text-black font-sans overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        
        <motion.h2 
          className="text-3xl md:text-4xl lg:text-4xl font-medium tracking-tight mb-10 text-gray-900"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
          Get your perfect resume in 3 steps
        </motion.h2>

        {/* <p className="text-gray-500 text-lg mb-16 md:mb-24">
          From raw resume to job-ready — in under a minute.
        </p> */}
